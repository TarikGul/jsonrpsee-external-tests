...
export const testRpcAuthor = async (api: ApiPromise, logger: Logger): Promise<void> => {
...
const rpcAuthorHasKey = async (api: ApiPromise, errorInfo: ErrorInfo = {}): Promise<ITestResult> => {
