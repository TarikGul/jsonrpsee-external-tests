...
export const testRpcOffChain = async (api: ApiPromise, logger: Logger) => {
    ...
    logger.logTestInfo(testLocalStorageGet.methodName, testLocalStorageGet.success);
}

const rpcOffChainLocalStorageGet = async (api: ApiPromise): Promise<ITestResult> => {
