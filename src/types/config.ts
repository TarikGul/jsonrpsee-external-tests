...
import { Index, Health, ApplyExtrinsicResult, NodeRole, PeerInfo } from '@polkadot/types/interfaces';
...
export type SubstrateInterfaceTypes = Index | Null | Health | ApplyExtrinsicResult | Text | Vec<Text> | Vec<NodeRole> | Vec<PeerInfo>;
