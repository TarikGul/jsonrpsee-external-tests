...
import { Index, Health, ApplyExtrinsicResult, NodeRole } from '@polkadot/types/interfaces';
...
export type SubstrateInterfaceTypes = Index | Null | Health | ApplyExtrinsicResult | Text | Vec<Text> | Vec<NodeRole>;
